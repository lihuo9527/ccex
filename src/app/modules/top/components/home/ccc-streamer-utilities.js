...
CCC.TRADE.unpack = function(tradeString) {
  ...
  var unpackedTrade = {};
  var currentField = 0;
  for (var property in CCC.CURRENT.FIELDS) {
...
CCC.CURRENT.pack = function(currentObject) {
  ...
  for (var property in CCC.CURRENT.FIELDS) {
    if (currentObject.hasOwnProperty(property)) {
      ...
      mask |= CCC.CURRENT.FIELDS[property];
    }
  }
...
export const unpack = CCC.CURRENT.unpack;